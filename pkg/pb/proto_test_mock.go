...
// Source: proto-test.trpc.go
//
// Generated by this command:
//
//	mockgen -destination=proto_test_mock.go -package=pb --source=proto-test.trpc.go -self_package=architectural-practices/proto-management/proto-test/pkg/pb
//
