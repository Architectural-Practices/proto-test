...
//
//	mockgen -destination=hello_test_mock.go -package=proto_test --source=hello-test.trpc.go -self_package=github.com/Architectural-Practices/proto-test
//

// Package proto_test is a generated GoMock package.
package proto_test
