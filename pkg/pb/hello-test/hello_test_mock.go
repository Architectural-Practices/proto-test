...
//
//	mockgen -destination=hello_test_mock.go -package=hello_test --source=hello-test.trpc.go -self_package=github.com/Architectural-Practices/proto-test/pkg/pb/hello-test
//
